        ...
        decoration: BoxDecoration(
          ...
          fit: BoxFit.cover
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                Text('$scale',style: TextStyle(fontSize: 120,color: Colors.white),),
                if(scale < 33 && scale >= 0)
                Text('SubhanAllah',style: TextStyle(fontSize: 30,color: Colors.white)),
                if(scale < 66 && scale >= 33)
                Text('Alhamdulillah',style: TextStyle(fontSize: 30,color: Colors.white)),
                      if(scale < 99 && scale >= 66 )
                Text('Allohu Akbar',style: TextStyle(fontSize: 30,color: Colors.white)),
